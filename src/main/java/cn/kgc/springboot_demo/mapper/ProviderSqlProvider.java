...
import cn.kgc.springboot_demo.pojo.ProviderExample.Criteria;
import cn.kgc.springboot_demo.pojo.ProviderExample.Criterion;
...
public class ProviderSqlProvider {
    ...
    public String insertSelective(Provider record) {
        ...
        if (record.getCompanylicpicpath() != null) {
            sql.VALUES("companyLicPicPath", "#{companylicpicpath,jdbcType=VARCHAR}");
        }
        
        if (record.getOrgcodepicpath() != null) {
            sql.VALUES("orgCodePicPath", "#{orgcodepicpath,jdbcType=VARCHAR}");
        }
    ...
    public String selectByExample(ProviderExample example) {
        ...
        sql.SELECT("modifyBy");
        sql.SELECT("companyLicPicPath");
        sql.SELECT("orgCodePicPath");
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getCompanylicpicpath() != null) {
            sql.SET("companyLicPicPath = #{record.companylicpicpath,jdbcType=VARCHAR}");
        }
        
        if (record.getOrgcodepicpath() != null) {
            sql.SET("orgCodePicPath = #{record.orgcodepicpath,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(Provider record) {
        ...
        if (record.getCompanylicpicpath() != null) {
            sql.SET("companyLicPicPath = #{companylicpicpath,jdbcType=VARCHAR}");
        }
        
        if (record.getOrgcodepicpath() != null) {
            sql.SET("orgCodePicPath = #{orgcodepicpath,jdbcType=VARCHAR}");
        }
